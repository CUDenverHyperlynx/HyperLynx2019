...
class Status():
    ...
    def __init__(self):
        ...
        self.abort_ranges = numpy.genfromtxt(r'abortranges.dat', skip_header=1, delimiter='\t', usecols=numpy.arange(1, 12))
...
def eval_abort():
    ...
    temp_fault_count = 0
    for i in range(a[0]):
        temp_fault_count += PodStatus.abort_ranges[i,10]
    ...
    for i in range(a[0]):
        temp_trigger_count += PodStatus.abort_ranges[i, 9]
